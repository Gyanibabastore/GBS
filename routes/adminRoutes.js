...
router.get('/buyer-details/:id', protect, isAdmin, adminController.getBuyerDetails);
router.get('/sellers-details/:id', protect, isAdmin, adminController.getSellerDetails);
router.get('/buyer-payment/:id', protect, isAdmin, adminController.getBuyerPaymentDetails);
router.get('/seller-payment/:id', protect, isAdmin, adminController.getSellerPaymentDetails);
